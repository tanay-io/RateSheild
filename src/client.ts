...
const environments = {
  production: 'https://ratesheild.onrender.com',
...
export interface ClientOptions {
   ...
   * - `production` corresponds to `https://ratesheild.onrender.com`
   ...
   *
   * Defaults to process.env['RATESHEILD_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['RATESHEILD_LOG'] or 'warn' if it isn't set.
   */
...
export class Ratesheild {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Ratesheild.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('RATESHEILD_LOG'), "process.env['RATESHEILD_LOG']", this) ??
      defaultLogLevel;
    ...
    const customHeadersEnv = readEnv('RATESHEILD_CUSTOM_HEADERS');
    if (customHeadersEnv) {
  ...
  static Ratesheild = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static RatesheildError = Errors.RatesheildError;
...
Ratesheild.Health = Health;
Ratesheild.Auth = Auth;
Ratesheild.Dashboard = Dashboard;
Ratesheild.Check = Check;

export declare namespace Ratesheild {
