...
import { APIPromise } from 'ratesheild/core/api-promise';

import util from 'node:util';
import Ratesheild from 'ratesheild';
import { APIUserAbortError } from 'ratesheild';
...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['RATESHEILD_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: Ratesheild) => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['RATESHEILD_BASE_URL'] = undefined;
    });
